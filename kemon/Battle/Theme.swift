...
extension Color {
    ...
    static let kemonCyan = Color(red: 0.24, green: 0.85, blue: 1.0)
    /// Deep indigo used for dark-on-cyan text and outlines.
    static let kemonInkBlue = Color(red: 0.184, green: 0.282, blue: 0.647)
}
...
extension LinearGradient {
    ...
    static let kemonSpace = LinearGradient(
        stops: [
...
extension View {
    ...
    func meloGlowText(color: Color = Color.kemonBlue) -> some View {
        self
...
struct KemonPrimaryButton: View {
    ...
    var tint: Color = Color.kemonBlue
    ...
    var body: some View {
        Button(action: action) {
            ...
            .foregroundStyle(Color.kemonInkBlue) // #2F48A5
...
struct AvatarBubble: View {
    ...
    var body: some View {
        ...
        .overlay {
            Circle()
                .strokeBorder(Color.kemonBlue, lineWidth: isSelected ? 3 : 0)
                .shadow(color: Color.kemonBlue, radius: isSelected ? 8 : 0)
                .padding(-4)
        }
