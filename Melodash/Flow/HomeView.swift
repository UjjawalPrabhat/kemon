    ...
    var body: some View {
        VStack(spacing: 40) {
            ...
            Image("logo-melodash")
                ...
                .shadow(color: Color.melodashBlue.opacity(0.85), radius: 16)
                .onAppear {
            ...
            MelodashPrimaryButton(title: "PLAY", systemImage: "play.fill") {
                battle.beginSetup()
            }
        ...
        .melodashPage(showPlanet: true, showCockpit: true)
    }
}
