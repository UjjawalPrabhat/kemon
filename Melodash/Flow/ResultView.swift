    ...
    private func playerCard(_ player: Player) -> some View {
        VStack(spacing: 20) {
            Text(player.displayName.uppercased())
                ...
                .padding(.vertical, 7)
                .background(
                    Capsule().stroke(Color.melodashInkBlue, lineWidth: 1.5)
                )
        ...
        .background(Color.melodashCyan)
        .clipShape(RoundedRectangle(cornerRadius: 28))
        .shadow(color: Color.melodashCyan.opacity(0.5), radius: 24)
    }
    ...
    private func metricRow(_ label: String, _ value: Int) -> some View {
        ...
        .background(
            SkewedBarShape()
                ...
                .shadow(color: Color.melodashBlue.opacity(0.55), radius: 10)
        )
    }
        ...
        if let upcoming = battle.upcomingPlayer {
            HStack(spacing: 18) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text(upcoming.displayName)
                        ...
                        .padding(.vertical, 4)
                        .background(Capsule().stroke(Color.melodashInkBlue, lineWidth: 1.2))
                }
                .padding(12)
                .background(RoundedRectangle(cornerRadius: 18).fill(Color.melodashCyan))
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 22)
                    .stroke(Color.melodashBlue.opacity(0.7), lineWidth: 2)
            )
            .shadow(color: Color.melodashBlue.opacity(0.5), radius: 14)
        } else {
            HStack(spacing: 12) {
