...
//  Melodash
//
//  Small view atoms shared across screens — artwork/avatar rendering plus the
//  reusable chip, section label, and back affordance — factored out of the
//  individual views so they live in one place.
//
